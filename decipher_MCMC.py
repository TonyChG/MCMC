...
def guess_from_frequency(logp, freq_text, ciphered_text):
    ...
    cur_like = likelihood(logp, cur_trad)
...
def main_loop(logp, cur_code, cur_like, best_like, ciphered_text):
    MIN_ITER = 2000
    MAX_ITER = 100000
    THRESHOLD = -2.05
    ALPHA = 1
    ...
    for k in range(MAX_ITER):
        ...
        tt_like = likelihood(logp, tt_trad)
...
def second_phase(
    dictionnary_data, best_trad, best_like, best_code, ciphered_text, logp
):
    print("\nEnter second phase")
